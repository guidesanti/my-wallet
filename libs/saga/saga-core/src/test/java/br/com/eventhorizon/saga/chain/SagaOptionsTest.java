...
public class SagaOptionsTest {
    ...
    public void testBuild() {
        ...
        Assertions.assertEquals(Long.valueOf(86400L), options.get(SagaOption.TRANSACTION_TTL));
        ...
        Assertions.assertEquals(Long.valueOf(10000L), options.get(SagaOption.TRANSACTION_TTL));

        options = new SagaOptions()
                .option(SagaOption.EVENT_REPUBLISH_ENABLED, false)
                .option(SagaOption.TRANSACTION_TTL, 250L);
        assertEquals(false, options.get(SagaOption.EVENT_REPUBLISH_ENABLED));
        Assertions.assertEquals(Long.valueOf(250L), options.get(SagaOption.TRANSACTION_TTL));
    }
